      ...
      <div class="desktop-1">
        <div class="frame-parent">
            ...
            <div class="sidebar-desktop">
                ...
                <img class="sheet-icon" alt="" src="/assets/images/admin/sheet.svg" />
                ...
                <img
                    ...
                    alt=""
                    src="/assets/images/admin/iconlylightoutlinecall@2x.png"
                />

                <img
                    class="sidebar-list-active-child"
                    alt=""
                    src="/assets/images/admin/group-37886.svg"
                />
                </div>
                ...
                <a class="title1" href="/docente/home?tab=gerenciamento">Gerenciamento</a>
                </div>
                ...
                <a class="title1" href="/docente/home?tab=alunos">Alunos</a>
                </div>
                ...
                <a class="title1" href="/docente/home?tab=professores">Professores</a>
                </div>
        ...
        <header class="desktop-1-inner">
            ...
            <img class="instance-child" alt="" src="/assets/images/admin/group-37876.svg" />
            </div>
        </header>
        <main style="position: absolute; left: 260px; top: 100px">
          <?php
