...
<head>
  ...
  <script src="{{ URL('js/index/index.js') }}" defer></script>
...
<body>
  <header>
    <nav>
      <img id="logo" src="{{ URL('images/index/logo.png') }}" class="shown logo">
      <img id="logo-dark" src="{{ URL('images/index/logo-dark.png') }}" class="hidden logo">
      <ul>
        <li>
          <a href="#">Quem Somos</a>
        </li>
  ...
  <div>
    <img id="bg-banner" class="shown bg-banner" src="{{ URL('images/index/mesh-gradient.png') }}">
    <img id="bg-banner-dark" class="hidden bg-banner" src="{{ URL('images/index/mesh-gradient-dark.png') }}">
  </div>
