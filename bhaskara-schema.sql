...
CREATE TABLE IF NOT EXISTS `db_bhaskara`.`tb_aluno_turma` (
  ...
  PRIMARY KEY (`id_turma`, `id_aluno`, `id_periodo_letivo`),
  INDEX `fk_tb_aluno_has_tb_turma_tb_turma1_idx` (`id_turma` ASC) ,
  INDEX `fk_tb_aluno_turma_tb_aluno1_idx` (`id_aluno` ASC) ,
  INDEX `fk_tb_aluno_turma_tb_periodo_letivo1_idx` (`id_periodo_letivo` ASC) ,
  CONSTRAINT `fk_tb_aluno_has_tb_turma_tb_turma1`
    FOREIGN KEY (`id_turma`)
    REFERENCES `db_bhaskara`.`tb_turma` (`cd_turma`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_aluno_turma_tb_aluno1`
    FOREIGN KEY (`id_aluno`)
    REFERENCES `db_bhaskara`.`tb_aluno` (`cd_aluno`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_aluno_turma_tb_periodo_letivo1`
...
CREATE TABLE IF NOT EXISTS `db_bhaskara`.`tb_falta` (
  ...
  INDEX `fk_tb_falta_tb_aluno1_idx` (`id_aluno` ASC) ,
  CONSTRAINT `fk_tb_falta_tb_aula2`
    FOREIGN KEY (`id_aula`)
    REFERENCES `db_bhaskara`.`tb_aula` (`cd_aula`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_falta_tb_aluno1`
    FOREIGN KEY (`id_aluno`)
    REFERENCES `db_bhaskara`.`tb_aluno` (`cd_aluno`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
