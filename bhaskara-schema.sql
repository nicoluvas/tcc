...
CREATE TABLE IF NOT EXISTS `db_bhaskara`.`tb_falta` (
  ...
  INDEX `fk_tb_falta_tb_matricula2_idx` (`id_aluno` ASC, `id_periodo_letivo` ASC) VISIBLE,
  INDEX `fk_tb_falta_tb_aula2_idx` (`id_aula` ASC) VISIBLE,
  CONSTRAINT `fk_tb_falta_tb_matricula2`
    FOREIGN KEY (`id_aluno` , `id_periodo_letivo`)
    REFERENCES `db_bhaskara`.`tb_matricula` (`id_aluno` , `id_periodo_letivo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `db_bhaskara`.`tb_matricula` (
  ...
  CONSTRAINT `fk_tb_matricula_tb_aluno2`
