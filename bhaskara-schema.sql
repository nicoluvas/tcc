...
CREATE TABLE IF NOT EXISTS `db_bhaskara`.`tb_admin` (
  ...
  `cd_codigo_acesso` TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `db_bhaskara`.`tb_aluno` (
  ...
  INDEX `fk_tb_aluno_tb_login1_idx` (`id_login` ASC) ,
  ...
  CONSTRAINT `fk_tb_aluno_tb_telefone1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_aluno_tb_login1`
    FOREIGN KEY (`id_login`)
    REFERENCES `db_bhaskara`.`tb_login` (`cd_login`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `db_bhaskara`.`tb_login`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `db_bhaskara`.`tb_login` ;

CREATE TABLE IF NOT EXISTS `db_bhaskara`.`tb_login` (
  `cd_login` INT NOT NULL AUTO_INCREMENT,
  `nm_usuario` VARCHAR(30) NOT NULL,
  `cd_codigo_acesso` TEXT NOT NULL,
  `tp_login` VARCHAR(15) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `db_bhaskara`.`tb_professor` (
  ...
  INDEX `fk_tb_professor_tb_pcd1_idx` (`tb_pcd_cd_pcd` ASC) ,
  INDEX `fk_tb_professor_tb_telefone1_idx` (`id_telefone` ASC) ,
  INDEX `fk_tb_professor_tb_login1_idx` (`id_login` ASC) ,
  ...
  CONSTRAINT `fk_tb_professor_tb_telefone1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_professor_tb_login1`
    FOREIGN KEY (`id_login`)
    REFERENCES `db_bhaskara`.`tb_login` (`cd_login`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
